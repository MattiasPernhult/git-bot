...
// message innehåller chuck norris
gitBot.prototype._isMentioningChuckNorris = function(message) {
...
gitBot.prototype._welcomeMessage = function() {
    this.postMessageToChannel(this.channels[0].name, 'Hi guys, having git problems?' +
        '\nNo problem because I\'m the Git Guru, start by typing gh: commands and I' +
        'will help you with whatever you ask me', {as_user: true});
};
